...
// E-04 게시글 작성 폼 — initialCategory로 카테고리 프리셀렉트
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <nav className="flex items-center gap-2 text-sm text-slate-500">
        ...
        <span className="font-medium text-slate-700">글쓰기</span>
      </nav>
      ...
      >
        <div className="grid gap-5 sm:grid-cols-[200px_1fr]">
          ...
          <input name="title" required placeholder="제목을 입력하세요" className="field" />
        </div>
        ...
        <div className="flex justify-end gap-3 border-t border-slate-100 pt-5">
          <Link href="/board" className="btn btn-outline px-5! py-2.5!">
            취소
          </Link>
